    ...
    <form @submit.prevent="userLogin">
      ...
      <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
            <button onclick="window.location.href = 'http://localhost:3000/user/reset';">Reset Password</button>
        ...
        "
        onclick="window.location.href = 'http://localhost:3000/user/loggedin';">Sign In</button>
    </form>
  </div>
</template>
...
export default {
  ...
  methods: {
    async userLogin() {
      try {
        await this.$auth.loginWith('http://localhost:1337/api/auth/local', {
